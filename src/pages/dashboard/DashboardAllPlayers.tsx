import { QUERY_PARAM_SEARCH } from "../../components/search-box/SearchBox";
...
export function DashboardAllPlayers() {
    ...
    const search = query.get(QUERY_PARAM_SEARCH);
    const page = query.get(QUERY_PARAM_PAGE);
                ...
                actionComponent={(
                    <Pagination
                        onChange={(_, value: number) => {
                            query.set(QUERY_PARAM_PAGE, value.toString());
                            setQuery(query);
                        }}
